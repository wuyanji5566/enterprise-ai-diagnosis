...
export const SERVICE_PACKAGES: ServicePackageDefinition[] = [
  ...
  },
  {
    ...
    cycle: "7–21天",
    price: "¥999–6,999 起",
    referenceBudget: "¥999–6,999 起",
    requiresPrivateQuote: true,
    reason: "适合先用一组可展示、可投放的营销样品验证获客价值。",
    suggestedNextStep: "选择一个核心产品，完成一次营销资产样品冲刺。"
  },
  {
    id: "automation",
    name: "企业AI效率自动化包",
    ...
    requiresPrivateQuote: true,
    reason: "适合从高频重复任务切入，用节省工时快速证明ROI。",
  ...
  },
  {
    ...
    deliverables: [
      "老板AI认知课",
      "员工AI工具课",
      "Codex/AI视频/AI图片/PPT实操",
      "企业真实项目陪跑",
      "课后复盘"
    ],
    cycle: "2–6周",
    price: "¥3,000–10,000 起",
    referenceBudget: "¥3,000–10,000 起",
    requiresPrivateQuote: true,
