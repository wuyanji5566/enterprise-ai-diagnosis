      ...
      <div className="grid md:grid-cols-[220px_1fr]">
        <div className="grid min-h-56 place-items-center border-b border-slate-200 bg-slate-50 p-6 md:border-b-0 md:border-r">
          {!imageFailed ? (
            <Image
              ...
              width={176}
              height={176}
              className="size-44 rounded-2xl border border-slate-200 bg-white object-cover p-2"
              onError={() => setImageFailed(true)}
            />
          ) : (
            <div className="grid size-44 place-items-center rounded-2xl border border-dashed border-slate-300 bg-white p-5 text-center">
              <div>
        ...
        <div className="p-7 sm:p-9">
          ...
          <div className="mt-6 rounded-xl bg-slate-50 p-4">
            ...
            <p className="mt-1 break-all font-mono text-base font-black text-ink">
              {siteConfig.contact.wechatId}
            </p>
          </div>
          <button type="button" className="primary-button mt-5 w-full" onClick={copyWechat}>
